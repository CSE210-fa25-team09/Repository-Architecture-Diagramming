...
1.  **Homepage (Zip Upload):** The implementation of the "Zip file" upload feature proved more complex than anticipated within the current timeline.
...
We have decided to refine the scope for both pages as follows:
...
* **Card Content Finalization:** We have finalized the previously undetermined details regarding the card UI. The Repository Input Card will strictly display:
    1.  **Repository Name**
    2.  **Repository Description**
    * ** This decision locks down the UI requirements that were left undetermined in the initial architecture planning.

### 2. Diagram Page Refinements
* **Graph Visualization Options:** The page will support **3 distinct options for graphs**.
...
* **Clarity:** Frontend developers now have a concrete specification for the card layout, removing the ambiguity of the initial design.
